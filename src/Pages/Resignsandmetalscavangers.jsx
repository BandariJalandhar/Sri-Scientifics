...
const Resignsandmetalscavangers = () => {
    return (
        <Center>
            <Box>
                <Box fontSize="20px" m="20px"> <Text color="#215878" as="b"> Resins & Metal Scavengers </Text> </Box>
                <Box>
                ...
                <Box>
                    <Box pt="20px"> 
                    <Box m="20px" fontSize="20px"> <Text color="#215878" as="b" pt="50px"> 
                    Silica Supported Metal Scavengers</Text> </Box>
                    <HStack m="15px" spacing={4}>
                        {/* Card 1 */}
                        <Box>
