    ...
    <div>
      ...
      <Box position="relative" top="0px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : LANSOPRAZOLE</Text></Box>
        ...
        <Link to="/Lacosamide1"><ListItem>LACOSAMIDE</ListItem></Link>
            ...
            <Link ><ListItem>LANSOPRAZOLE</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px"> Lansoprazole Impurity-C (or) Lansoprazole Sulfide  </Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> : 103577-40-8</Text> 
            </HStack>
            <HStack>
        ...
        {/* <Card className='Subcard' boxShadow="dark-lg">              
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px">Lactose Olamine adduct  (OR) (or) Eltrombopag Olamine Impurity</Text>
            <Divider marginTop="10px" paddingTop="5px"/>
            <Box padding="10px">
              <Image src="/phy.png" className='Image'></Image>
            </Box>
         ...
         {/* <Card className='Subcard' boxShadow="dark-lg">              
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px"> Lacosamide EP Impurity I </Text>
            <Divider marginTop="10px" paddingTop="5px"/>
            <Box padding="10px">
              <Image src="/phy.png" className='Image'></Image>
            </Box>
