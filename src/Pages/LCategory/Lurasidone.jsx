    ...
    <div>
      ...
      <Box position="relative" top="-250px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : LURASIDONE</Text></Box>
        ...
        <Link to="/Lacosamide1"><ListItem>LACOSAMIDE</ListItem></Link>
            ...
            <Link ><ListItem>LURASIDONE</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px">Lurasidone Enantiomer </Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> :1448443-35-3</Text> 
            </HStack>
            <HStack>
       ...
       <Card className='Subcard' boxShadow="dark-lg">              
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px">(3aS,4S,7R,7aR)(1R,2R) Stereo Isomer</Text>
            <Divider marginTop="10px" paddingTop="5px"/>
            <Box padding="10px">
              <Image src="/phy.png" className='Image'></Image>
            </Box>
           ...
           <Card className='Subcard' boxShadow="dark-lg">              
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px"> (3aR,4S,7R,7aS)(1S,2R)/ (3aR,4S,7R,7aS)(1R,2S) Stereo Isomer   </Text>
            <Divider marginTop="10px" paddingTop="5px"/>
            <Box padding="10px">
              <Image src="/phy.png" className='Image'></Image>
            </Box>
           ...
           <HStack>
                <Card className='Subcard' boxShadow="dark-lg">              
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px"> Spiro compound </Text>
            <Divider marginTop="10px" paddingTop="5px"/>
            <Box padding="10px">
              <Image src="/phy.png" className='Image'></Image>
            </Box>
