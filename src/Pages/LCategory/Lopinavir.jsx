    ...
    <div>
      ...
      <Box position="relative" top="0px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : LOPINAVIR</Text></Box>
        ...
        <Link to="/Lacosamide1"><ListItem>LACOSAMIDE</ListItem></Link>
            ...
            <Link ><ListItem>LOPINAVIR</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px">Lopinavir-(S)-2-(2,4-Dioxo-tetrahydropyrimidin-1-yl)-3-methyl butyric acid (or) Lopinavir Impurity-1</Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> : 192725-89-6</Text> 
            </HStack>
            <HStack>
