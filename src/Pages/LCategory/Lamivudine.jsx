    ...
    <div>
      ...
      <Box position="relative" top="0px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : LAMIVUDINE</Text></Box>
        ...
        <Link to="/Lacosamide1"><ListItem>LACOSAMIDE</ListItem></Link>
            ...
            <Link ><ListItem>LAMIVUDINE</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px"> Lamivudine -Impurity-B  </Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> : 136846-20-3</Text> 
            </HStack>
            <HStack>
