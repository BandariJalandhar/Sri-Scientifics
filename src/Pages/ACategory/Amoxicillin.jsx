    ...
    <div>  
      ...
      <Box position="relative" top="-290px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : AMOXICILLIN</Text></Box>
        ...
        <Link to='/Abiraterone'><ListItem>Abiraterone</ListItem></Link>
           ...
           <Link to='/Aminocaproicacid'> <ListItem>Aminocaproic</ListItem></Link>
           <Link to='/Amlodopin'> <ListItem> Amlodopin</ListItem></Link>
           <Link to='/Albendazole'> <ListItem >Albendazole</ListItem></Link>
            <Link to='/Acecolfenc'><ListItem >Acecolfenac</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
            ...
            <HStack>
                ...
                <Card  className='Subcard' boxShadow="dark-lg">              
                  <CardBody>
                    <Text align="justify" textAlign="center" fontSize="20px">Amoxicillin-Related compound J</Text>
                    ...
                    <HStack>
                      ...
                      <Text paddingLeft="0px"> : SZ-A025027</Text> 
                    </HStack>
                    <HStack>
                    ...
                    <HStack>
                      ...
                      <Text paddingLeft="15px"> : C32H38N6O10S2</Text> 
                    </HStack>
                    <HStack>
                      <Box> <Text>Mol.Wt.</Text> </Box>
                      <Text paddingLeft="5px"> : 730.8</Text> 
                    </HStack>
                    <HStack>
                ...
                <Card className='Subcard' boxShadow="dark-lg">              
                  <CardBody>
                    <Text align="justify" textAlign="center" fontSize="20px">Amoxicillin-IMP I (or) related compound I</Text>  
                    <Divider marginTop="10px" paddingTop="5px"/>
                    <Box padding="10px">
                      <Image src="/phy.png"  className='Image'></Image>
                    </Box>
                    ...
                    <HStack>
                      <Box> <Text>CAT NO </Text> </Box>
                      <Text paddingLeft="0px"> : SZ-A025010 </Text>
        
                    </HStack>
                    <HStack>
                      <Box> <Text>CAS NO</Text> </Box>
                      <Text paddingLeft="0px"> : 22818-40-2 </Text> 
                    </HStack>
                    <HStack>
                      <Box> <Text>Mol.F.</Text> </Box>
                      <Text paddingLeft="15px"> : C8H9NO3
        </Text> 
                    </HStack>
                    <HStack>
                      <Box> <Text>Mol.Wt.</Text> </Box>
                    ...
                    <HStack>
                      ...
                      <Text color="blue" paddingLeft="0px"> :  In Stock
                        ...
                        <Card className='Subcard' boxShadow="dark-lg">
                  <CardBody>
                    <Text align="justify" textAlign="center" fontSize="20px"> Amoxicillin Related Compound L (or) EP Impurity L</Text>
                    <Divider marginTop="10px" paddingTop="5px"/>
                    <Box padding="10px">
                      <Image src="/phy.png"  className='Image'></Image>
                    </Box>
                    ...
                    <HStack>
                      <Box> <Text>CAT NO </Text> </Box>
                      <Text paddingLeft="0px"> : SZ-A025013</Text> 
                    </HStack>
                    <HStack>
                      <Box> <Text>CAS NO</Text> </Box>
                      <Text paddingLeft="0px"> :  1789703-32-7
        </Text> 
                    </HStack>
                    <HStack>
                      <Box> <Text>Mol.F.</Text> </Box>
                      <Text paddingLeft="15px"> : C24H29N5O7S2</Text> 
                    </HStack>
                    <HStack>
                      <Box> <Text>Mol.Wt.</Text> </Box>
                      <Text paddingLeft="5px"> : 563.6</Text> 
                    </HStack>
                    <HStack>
                      <Box> <Text color="blue">lnv.Staus</Text> </Box>
        ...
        <HStack> 
                   <Card className='Subcard' boxShadow="dark-lg">
                  <CardBody>
                    <Text align="justify" textAlign="center" fontSize="20px">N-Pivoloyl Amoxicillin</Text>
                    <Divider marginTop="10px" paddingTop="5px"/>
                    <Box padding="10px">
                      <Image src="/phy.png" className='Image'></Image>
                    </Box>
                    ...
                    <HStack>
                      <Box> <Text>CAT NO </Text> </Box>
                      <Text paddingLeft="0px"> : SZ-A025016 </Text> 
                    </HStack>
                    <HStack>
                      <Box> <Text>CAS NO</Text> </Box>
                      <Text paddingLeft="0px"> : 1313237-94-3</Text> 
                    </HStack>
                    <HStack>
                      <Box> <Text>Mol.F.</Text> </Box>
                      <Text paddingLeft="15px"> : C21H27N3O6S</Text> 
                    </HStack>
                    <HStack>
                      <Box> <Text>Mol.Wt.</Text> </Box>
                      <Text paddingLeft="5px"> : 449.5</Text> 
                    </HStack>
                    <HStack>
                      <Box> <Text color="blue">lnv.Staus</Text> </Box>
                      <Text color="blue" paddingLeft="0px"> : ln Stock</Text> 
