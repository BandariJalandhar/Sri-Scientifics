    ...
    <div>
      ...
      <Box position="relative" top="-40px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : ATROPINE</Text></Box>
        ...
        <Link to='/Abiraterone'><ListItem>Abiraterone</ListItem></Link>
           ...
           <Link to='/Albendazole'> <ListItem >Albendazole</ListItem></Link>
            ...
            <Link ><ListItem>Atropine</ListItem></Link>        
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px"> Atropine N-Oxide</Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> : SZ-A029012 </Text> 
            </HStack>
            <HStack>
              <Box> <Text>CAS NO</Text> </Box>
              <Text paddingLeft="0px"> : 4574-60-1
</Text> 
            </HStack>
            <HStack>
              <Box> <Text>Mol.F.</Text> </Box>
              <Text paddingLeft="15px"> : C17H23NO4 : HCl</Text> 
            </HStack>
            <HStack>
              <Box> <Text>Mol.Wt.</Text> </Box>
              <Text paddingLeft="5px"> : 305.4 : 36.5</Text> 
            </HStack>
            <HStack>
