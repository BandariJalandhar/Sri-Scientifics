    ...
    return (
        ...
        <Box position="relative" top="-40px">
            ...
            <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : PACLITAXEL</Text></Box>
    ...
    <Card className='Subcard' boxShadow="dark-lg">              
        <CardBody>
        <Text align="justify" textAlign="center" fontSize="20px">paclitaxel standard</Text>
    ...
    <Box> <Text>CAT NO </Text> </Box>
        <Text paddingLeft="0px"> : SZ-P032001</Text> 
    </HStack>
    <HStack>
    <Box> <Text>CAS NO</Text> </Box>
    <Text paddingLeft="0px"> : 33069-62-4</Text> 
    </HStack>
    <HStack>
    <Box> <Text>Mol.F.</Text> </Box>
    <Text paddingLeft="15px">: C47H51NO14</Text> 
    </HStack>
    <HStack>
    <Box> <Text>Mol.Wt.</Text> </Box>
    <Text paddingLeft="5px"> : 853.9 </Text> 
    </HStack>
    <HStack>
    ...
    <Card className='Subcard' boxShadow="dark-lg">              
    <CardBody>
    <Text align="justify" textAlign="center" fontSize="20px"> Paclitaxel Related Compound-B (or) Impurity-H</Text>
    <Divider marginTop="10px" paddingTop="5px"/>
    <Box padding="10px">
    <Image src="/phy.png" className='Image'></Image>
        </Box>
        ...
        <HStack>
        <Box> <Text>CAT NO </Text> </Box>
        <Text paddingLeft="0px"> : SZ-P032132</Text> 
        </HStack>
    <HStack>
    <Box> <Text>CAS NO</Text> </Box>
        <Text paddingLeft="0px"> : 78454-17-8</Text> 
    </HStack>
        <HStack>
    <Box> <Text>Mol.F.</Text> </Box>
        <Text paddingLeft="15px"> : C45H49NO13</Text> 
        </HStack>
        <HStack>
        <Box> <Text>Mol.Wt.</Text> </Box>
        <Text paddingLeft="5px"> : 811.9</Text> 
        </HStack>
        <HStack>
        <Box> <Text color="blue">lnv.Staus</Text> </Box>
        <Text color="blue" paddingLeft="0px"> : ln Stock</Text> 
