    ...
    <div>
      ...
      <Box position="relative" top="-40px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : PILOCARPINE</Text></Box>
        ...
        <UnorderedList margin="2px" spacing="10px">
           ...
           <Link to='/Phenoxy BEnzamine'><ListItem >Phenoxy Benzamine</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px"> Pilocarpine imp A</Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> : SZ-P092002 </Text> 
            </HStack>
            <HStack>
              <Box> <Text>CAS NO</Text> </Box>
              <Text paddingLeft="0px"> : 531-35-1</Text> 
            </HStack>
            <HStack>
