    ...
    <div>
      ...
      <Box position="relative" top="-40px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : PENOXYBENZAMINE </Text></Box>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px"> phenoxy benzamine alcohol imp </Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> : 101-45-1</Text> 
            </HStack>
            <HStack>
        ...
        <Card className='Subcard' boxShadow="dark-lg">              
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px">Phenoxybenzamine Nitrile</Text>
            <Divider marginTop="10px" paddingTop="5px"/>
            <Box padding="10px">
              <Image src="/phy.png" className='Image'></Image>
            </Box>
            ...
            <HStack>
              <Box> <Text>CAT NO </Text> </Box>
              <Text paddingLeft="0px"> : SZ-P017008 </Text> 
            </HStack>
            <HStack>
              <Box> <Text>CAS NO</Text> </Box>
              <Text paddingLeft="0px"> : 2512203-93-7</Text> 
            </HStack>
            <HStack>
              <Box> <Text>Mol.F.</Text> </Box>
              <Text paddingLeft="15px"> : C19H22N2O </Text> 
            </HStack>
            <HStack>
              <Box> <Text>Mol.Wt.</Text> </Box>
...
export default  Phenoxybenzamine; 