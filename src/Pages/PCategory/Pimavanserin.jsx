    ...
    <div>
      ...
      <Box position="relative" top="-40px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : PIMAVASERIN </Text></Box>
...
<Box>
     ...
     <HStack>
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px">pimavanserin tartarate</Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> : SZ-P058027</Text> 
            </HStack>
            <HStack>
              <Box> <Text>CAS NO</Text> </Box>
              <Text paddingLeft="0px"> : 706782-28-7</Text> 
            </HStack>
            <HStack>
              <Box> <Text>Mol.F.</Text> </Box>
              <Text paddingLeft="15px"> :  C4H6O6 </Text> 
            </HStack>
            <HStack>
              <Box> <Text>Mol.Wt.</Text> </Box>
              <Text paddingLeft="5px"> : 427.6 : 150.1</Text> 
            </HStack>
            <HStack>
