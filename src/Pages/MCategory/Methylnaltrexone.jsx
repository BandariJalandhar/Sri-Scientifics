        ...
        import { Link } from 'react-router-dom'
            ...
            return (
                ...
                <Box position="relative" top="-30px">
                    ...
                    <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : METHYLNALTREXONE </Text></Box>
                    ...
                    <Box display='block' overflowY='scroll' paddingLeft="80px" marginTop="10px">
            ...
            <Box>
                    ...
                    <CardBody>
                        <Text align="justify" textAlign="center" fontSize="20px">Methylnaltrexone Diol Impurity </Text>
            ...
            export default Methylnaltrexone
