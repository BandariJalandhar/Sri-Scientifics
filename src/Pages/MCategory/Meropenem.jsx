        ...
        return (
            ...
            <Box position="relative" top="-30px">
                ...
                <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : MEROPENEM </Text></Box>
        ...
        <Box>
                ...
                <CardBody>
                    <Text align="justify" textAlign="center" fontSize="20px">Meropenem trihydrate </Text>
