        ...
        return (
            ...
            <Box position="relative" top="-40px">
                ...
                <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : MIRABEGRON</Text></Box>
        ...
        <Box>
                ...
                <CardBody>
                    <Text align="justify" textAlign="center" fontSize="20px">Sucrose heptasulfate Potassium Salt </Text>
                ...
                <Card className='Subcard' boxShadow="dark-lg">              
                <CardBody>
                    <Text align="justify" textAlign="center" fontSize="20px">Sucrose Octasulfate Potassium Salt </Text>
                    <Divider marginTop="10px" paddingTop="5px"/>
                    <Box padding="10px">
                    <Image src="/phy.png" className='Image'></Image>
                    </Box>
