import { Box, HStack, Image, Heading, Flex, Text, Stack, Card, CardBody, Center } from '@chakra-ui/react'
...
const Resignsandmetalscavangers2 = () => {
    return (
        ...
        <Box m="40px">           
            ...
            <Box m="20px" className='head'> 
            <Heading color="#215878" size="md"> Polystyrene Supported metal Scavengers</Heading>
            </Box>
                ...
                <Box>
                  <Box m="25px"> <Heading color="#215878" size="md" > Polymer Bound Regents</Heading> </Box>
                    <HStack m="15px" spacing={4}>                         
                        <Box     >
                            <Card className='resigns' >
                                <CardBody>
                ...
                <Box>
                    <Box m="25px"> 
                    <Heading color="#215878" size="md">Ion Exchange Resign</Heading> </Box>
                    <HStack m="15px" spacing={4}>
                        {/* Card-1 */}
                        <Box     >
                            <Card className='resigns' >
                ...
                <Box>
                    <Box m="25px"> 
                    <Heading color="#215878" size="md">Reverse Phase Silica Gel</Heading> </Box>
                    <HStack m="15px" spacing={4}>
                        {/* Card-1 */}
                        <Box     >
                            <Card className='resigns' >
                ...
                <Box>                    
                    <Box m="25px"> <Heading color="#215878" size="md">Linkers</Heading> </Box> 
                    <HStack m="15px" spacing={4}>
                        {/* Card-1 */}
                        <Box >
                            <Card className='resigns' >
                    ...
                    <Box>  
                    <Box m="25px"> 
                    <Heading color="#215878" size="md" >Fmoc-Protected Amino Acid</Heading></Box>
                    <HStack m="15px" spacing={4}>
                        {/* Card-1 */}
                        <Box     >
                            <Card className='resigns' >
