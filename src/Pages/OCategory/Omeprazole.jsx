    ...
    <div>
      ...
      <Box position="relative" top="0px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : OMEPRAZOLE</Text></Box>
        ...
        <UnorderedList margin="2px" spacing="10px">
            ...
            <Link ><ListItem>OMEPRAZOLE</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px">Omeprazole Related Compound F &G mixture</Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> :125656-82-8 & 125656-83-9</Text> 
            </HStack>
            <HStack>
