    ...
    <div>
      ...
      <Box position="relative" top="0px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : RIBOFLAVIN </Text></Box>
        ...
        <Link to="/Raloxifene"> <ListItem>RALOXIFENE</ListItem></Link>
         ...
         <Link > <ListItem>RIBOFLAVIN</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px">Riboflavin </Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> : 83-88-5</Text> 
            </HStack>
            <HStack>
