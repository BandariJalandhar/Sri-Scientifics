    ...
    <div>
      ...
      <Box position="relative" top="0px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : ESZOPICLONEE</Text></Box>
        ...
        <Link to="/Ebastine"><ListItem>EBASTINE</ListItem></Link>
            ...
            <Link ><ListItem>ESZOPICLONEE</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px"> Eszopiclonee -R Isomer  </Text>
