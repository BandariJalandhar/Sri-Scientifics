    ...
    <div>
      ...
      <Box position="relative" top="0px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : EXEMESTANE</Text></Box>
        ...
        <UnorderedList margin="2px" spacing="10px">
            ...
            <Link><ListItem>EXEMESTANE</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px"> Exemestane  </Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> : 107868-30-4</Text> 
            </HStack>
            <HStack>
