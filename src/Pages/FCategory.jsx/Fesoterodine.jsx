 ...
 import React from 'react'
     ...
     return (
         ...
         <Box position="relative" top="-40px">
             ...
             <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : FESTERODINE </Text></Box>
     ...
     <Box>
             ...
             <CardBody>
                 <Text align="justify" textAlign="center" fontSize="20px">Fesoterodine Fumarate ester of Diol</Text>
                 ...
                 <Text paddingLeft="0px"> : SZ-F002013</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>CAS NO</Text> </Box>
                 <Text paddingLeft="0px"> : 1428856-4-6</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>Mol.F.</Text> </Box>
                 <Text paddingLeft="15px"> : C26H33NO5</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>Mol.Wt.</Text> </Box>
                 <Text paddingLeft="5px"> : 439.6</Text> 
                 </HStack>
                 <HStack>
             ...
             <Card className='Subcard' boxShadow="dark-lg">              
             <CardBody>
                 <Text align="justify" textAlign="center" fontSize="20px">Fesoterodine Fumarate</Text>
                 <Divider marginTop="10px" paddingTop="5px"/>
                 <Box padding="10px">
                 <Image src="/phy.png" className='Image'></Image>
                 </Box>
                 ...
                 <HStack>
                 <Box> <Text>CAT NO </Text> </Box>
                 <Text paddingLeft="0px"> : SZ-F002001</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>CAS NO</Text> </Box>
                 <Text paddingLeft="0px"> : 286930-03-8</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>Mol.F.</Text> </Box>
                 <Text paddingLeft="15px"> : C26H37NO3 </Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>Mol.Wt.</Text> </Box>
                 <Text paddingLeft="5px"> :  411.6 </Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text color="blue">lnv.Staus</Text> </Box>
                 <Text color="blue" paddingLeft="0px"> : ln Stock</Text> 
