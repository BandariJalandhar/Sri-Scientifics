 ...
 import React from 'react'
     ...
     return (
         ...
         <Box position="relative" top="-290px">
             ...
             <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : FEXFENADINE 2</Text></Box>
             ...
             <Link to='/Fesoterodine'> <ListItem>Fesoterodine 1</ListItem></Link>
             <Link to='/Fesotreidone'> <ListItem>Fesoterodine 2</ListItem></Link>
     ...
     <Box>
             ...
             <CardBody>
                 <Text align="justify" textAlign="center" fontSize="20px">Fexofenidine-Related compound-A</Text>
                 ...
                 <Text paddingLeft="0px"> : SZ-F026002</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>CAS NO</Text> </Box>
                 <Text paddingLeft="0px"> : 76811-98-8</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>Mol.F.</Text> </Box>
                 <Text paddingLeft="15px"> : C32H37NO4</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>Mol.Wt.</Text> </Box>
                 <Text paddingLeft="5px"> : 499.7</Text> 
                 </HStack>
                 <HStack>
             ...
             <Card className='Subcard' boxShadow="dark-lg">              
             <CardBody>
                 <Text align="justify" textAlign="center" fontSize="20px">Fexofenidine-Related compound-B</Text>
                 <Divider marginTop="10px" paddingTop="5px"/>
                 <Box padding="10px">
                 <Image src="/phy.png" className='Image'></Image>
                 </Box>
                 ...
                 <HStack>
                 <Box> <Text>CAT NO </Text> </Box>
                 <Text paddingLeft="0px"> : SZ-F026003</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>CAS NO</Text> </Box>
                 <Text paddingLeft="0px"> : 479035-75-1</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>Mol.F.</Text> </Box>
                 <Text paddingLeft="15px"> : C32H39NO4</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>Mol.Wt.</Text> </Box>
                 <Text paddingLeft="5px"> :  501.7</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text color="blue">lnv.Staus</Text> </Box>
                 <Text color="blue" paddingLeft="0px"> : ln Stock</Text> 
             ...
             <Card className='Subcard' boxShadow="dark-lg">              
             <CardBody>
                 <Text align="justify" textAlign="center" fontSize="20px">Fexofenidine-Related compound-C </Text>
                 <Divider marginTop="10px" paddingTop="5px"/>
                 <Box padding="10px">
                 <Image src="/phy.png"  className='Image'></Image>
                 </Box>
                 ...
                 <HStack>
                 <Box> <Text>CAT NO </Text> </Box>
                 <Text paddingLeft="0px"> : SZ-F026004</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>CAS NO</Text> </Box>
                 <Text paddingLeft="0px"> : 185066-37-9</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>Mol.F.</Text> </Box>
                 <Text paddingLeft="15px"> : C31H39NO2 </Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>Mol.Wt.</Text> </Box>
                 <Text paddingLeft="5px"> : 457.7</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text color="blue">lnv.Staus</Text> </Box>
                 <Text color="blue" paddingLeft="0px"> : ln Stock</Text> 
             ...
             <Card className='Subcard' boxShadow="dark-lg">              
             <CardBody>
                 <Text align="justify" textAlign="center" fontSize="20px">Fexofenedine</Text>
                 <Divider marginTop="10px" paddingTop="5px"/>
                 <Box padding="10px">
                 <Image src="/phy.png"  className='Image'></Image>
                 </Box>
                 ...
                 <HStack>
                 <Box> <Text>CAT NO </Text> </Box>
                 <Text paddingLeft="0px"> : SZ-F026001</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>CAS NO</Text> </Box>
                 <Text paddingLeft="0px"> : 83799-24-0</Text> 
                 </HStack>
                 <HStack>
                 <Box> <Text>Mol.F.</Text> </Box>
                 <Text paddingLeft="15px"> : C32H39NO4 </Text> 
