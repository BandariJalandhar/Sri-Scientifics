    ...
    <div>
      ...
      <Box position="relative" top="0px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : BRIVARACETAM </Text></Box>
        ...
        <Link to="/Baclofen"><ListItem>BACLOFEN</ListItem></Link>
            ...
            <Link ><ListItem>BRIVARACETAM</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px">Brivaracetam Acid impurity  </Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> : 943986-67-2</Text> 
            </HStack>
            <HStack>
