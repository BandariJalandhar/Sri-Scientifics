    ...
    <div>
      ...
      <Box position="relative" top="0px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : VIGABATRIN</Text></Box>
        ...
        <UnorderedList margin="2px" spacing="10px">
            ...
            <Link ><ListItem>VIGABATRIN</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px">Vigabatrin EP Impurity A  </Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> :7529-16-0</Text> 
            </HStack>
            <HStack>
