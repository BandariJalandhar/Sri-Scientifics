    ...
    <div>
      ...
      <Box position="relative" top="-40px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category :TOLTERODINE </Text></Box>
        ...
        <UnorderedList margin="2px" spacing="10px">
           ...
           <Link to='/Trisalicylic Acid'> <ListItem >Trisalicylic Acid</ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px">Tolterodine O-Benzyl Impurity</Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> : 389068-22-8</Text> 
            </HStack>
            <HStack>
