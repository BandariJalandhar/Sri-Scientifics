    ...
    <div>
      ...
      <Box position="relative" top="-40px">
        <Box width="300px" paddingLeft="30px" borderColor="gray"> 
          <Box margin="1px" padding="10px" paddingTop="60px"><Text  paddingBottom="15px" marginBottom="1px" borderBottom="1px">Category : THEOBROMINE</Text></Box>
        ...
        <UnorderedList margin="2px" spacing="10px">
           ...
           <Link to='/Tamoxifen'> <ListItem >Tamoxifine </ListItem></Link>
...
<Box>
         ...
         <Box margin="10px" marginLeft="20px">
          ...
          <CardBody>
            <Text align="justify" textAlign="center" fontSize="20px">Theobromine</Text>
            ...
            <HStack>
              ...
              <Text paddingLeft="0px"> : SZ-P063002</Text> 
            </HStack>
            <HStack>
              <Box> <Text>CAS NO</Text> </Box>
              <Text paddingLeft="0px"> : 83-67-0</Text> 
            </HStack>
            <HStack>
